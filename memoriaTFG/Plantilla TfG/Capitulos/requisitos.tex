...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{../../docs/diagramas/casos-uso/casos-uso-consumidor.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{../../docs/diagramas/casos-uso/casos-uso-comercio-admin.png}
