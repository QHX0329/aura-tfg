...
5. **Servicios externos:** Claude API (Anthropic), Google Maps / OSRM, Tesseract OCR y Sentry.
...
- **Backend → PostgreSQL:** Django ORM con consultas geoespaciales mediante `django.contrib.gis` y `django-geojson`.
