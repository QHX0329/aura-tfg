...
| Seed de datos de prueba (fixtures) | 3 | S5 | `backend/scripts/seed.py` |
...
Basado en el *Informe final de la consulta preliminar del mercado de perfiles profesionales en el ámbito informático* (Junta de Andalucía, 2018), columna "Media acotada todos valores" para perfiles junior (<6 años de experiencia):
